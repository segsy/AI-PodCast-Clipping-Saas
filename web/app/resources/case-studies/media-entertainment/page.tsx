...
export default function MediaEntertainmentCaseStudy() {
  const [activeSlide, setActiveSlide] = useState(0);

  const slides = [
    { 
      title: "The Challenge", 
      description: "Production team was overwhelmed with hours of raw footage that never got edited",
      image: "https://images.unsplash.com/photo-1492691527719-9d1e07e534b4?w=1200&h=600&fit=crop",
      stat: "100+ Hours"
    },
    { 
      title: "The Solution", 
      description: "Implemented AI clipping to automatically identify best moments from all content",
      image: "https://images.unsplash.com/photo-1574717024653-61fd2cf4d44d?w=1200&h=600&fit=crop",
      stat: "AI Powered"
    },
    { 
      title: "Workflow Revolution", 
      description: "Entire team shifted from editing to strategy - 10x more content produced",
      image: "https://images.unsplash.com/photo-1536240478700-b869070f9279?w=1200&h=600&fit=crop",
      stat: "10x Content"
    },
    { 
      title: "Audience Explosion", 
      description: "Reached 10x more audiences across all platforms with consistent short-form content",
      image: "https://images.unsplash.com/photo-1611162616305-c69b3fa7fbe0?w=1200&h=600&fit=crop",
      stat: "10x Reach"
    },
    { 
      title: "Cost Savings", 
      description: "Reduced editing costs by 70% while producing more content than ever",
      image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1200&h=600&fit=crop",
      stat: "70% Savings"
    },
    { 
      title: "Scale Phase", 
      description: "Now producing 500+ shorts per month with a fraction of the original team",
  ...
  const metrics = [
    { value: "10x", label: "More Content", icon: TrendingUp },
    { value: "70%", label: "Cost Reduction", icon: DollarSign },
    { value: "5hrs", label: "Saved Daily", icon: Clock },
    { value: "10x", label: "Audience Growth", icon: Users },
  ];

  const benefits = [
    "Process unlimited hours of footage automatically",
    "Create platform-specific versions for each social network",
    "Maintain consistent brand voice across all content",
    "Scale content production without hiring more editors",
    "Turn archived content into fresh viral material"
  ];

  const testimonials = [
    {
      quote: "We went from posting once a week to 50 times a day. Our audience grew from 10K to 2M in 8 months.",
      author: "Marcus Chen",
      role: "Head of Production",
      company: "StreamMedia Productions"
    },
    {
      quote: "The ROI was immediate. We saved $15K/month on editing costs and our engagement quadrupled.",
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "0 24px" }}>
          ...
          <div style={{ marginBottom: "48px" }}>
            ...
            <h1 style={{ fontSize: "48px", fontWeight: "bold", marginTop: "16px", marginBottom: "16px" }}>
              Streamline Video Creation Workflow & Reach 10x More Audiences
            </h1>
            <p style={{ fontSize: "20px", color: "var(--text-secondary)", maxWidth: "700px" }}>
              See how entertainment companies are transforming their content production and reaching millions of new viewers.
            </p>
          </div>
          ...
          <div style={{ 
            ...
            {metrics.map((metric, index) => (
              <div key={index} style={{ 
                ...
                <metric.icon size={32} style={{ color: "#8b5cf6", marginBottom: "12px" }} />
                ...
                {slides.map((_, index) => (
                  <button
                    ...
                    style={{
                      ...
                      height: "8px",
                      borderRadius: "4px",
                      backgroundColor: index === activeSlide ? "#8b5cf6" : "var(--border)",
                      border: "none",
                      cursor: "pointer",
                      transition: "all 0.3s"
                    }}
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: "24px" }}>
              {testimonials.map((testimonial, index) => (
                <div key={index} style={{ 
                  ...
                  <Quote size={32} style={{ color: "#8b5cf6", marginBottom: "16px" }} />
          ...
          <div style={{ 
            ...
            <p style={{ fontSize: "18px", color: "var(--text-secondary)", marginBottom: "32px", maxWidth: "600px", margin: "0 auto 32px" }}>
              Join leading media companies transforming their video content workflow.
            </p>
