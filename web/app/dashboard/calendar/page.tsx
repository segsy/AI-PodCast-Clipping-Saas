...
const platforms = [
  { name: "YOUTUBE", label: "YouTube", icon: "ðŸ“º", color: "#FF0000" },
  { name: "TIKTOK", label: "TikTok", icon: "ðŸŽµ", color: "#000000" },
  { name: "INSTAGRAM", label: "Instagram", icon: "ðŸ“¸", color: "#E1306C" },
  { name: "FACEBOOK", label: "Facebook", icon: "ðŸ“˜", color: "#1877F2" },
  { name: "LINKEDIN", label: "LinkedIn", icon: "ðŸ’¼", color: "#0A66C2" },
  { name: "TWITTER", label: "X", icon: "ðŸ¦", color: "#1DA1F2" },
];
