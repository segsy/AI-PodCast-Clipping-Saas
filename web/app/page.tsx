...
export default function HomePage() {
  ...
  const caseStudyItems = [
    { name: "How Clip helps marketing agencies boost revenue by 150%", href: "/resources/case-studies/marketing-agencies", image: "marketing" },
  ...
  const businessMenuItems = [
    ...
    { name: "API Access", href: "/resources/api", description: "Build with Clip's powerful API", icon: LinkIcon },
            ...
            <div className="max-w-md mx-auto space-y-6">
              ...
              <div className="pt-4 border-t border-border space-y-3">
                <button
                  ...
                  className="w-full text-text-secondary hover:text-white transition-colors font-medium py-3"
                >
                  Sign In
                </button>
                <button
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-8 mb-12">
            {[
              ...
              <Link
                key={index}
                href={`/dashboard?feature=${feature.id}`}
