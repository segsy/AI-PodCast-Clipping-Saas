...
CREATE TABLE "caption_jobs" (
	...
	"speaker_identification" boolean DEFAULT true NOT NULL,
...
CREATE TABLE "thumbnail_jobs" (
	...
	"project_id" text,
	"status" text DEFAULT 'PENDING' NOT NULL,
	"style" text DEFAULT 'vibrant' NOT NULL,
	"aspect_ratio" text DEFAULT '16:9' NOT NULL,
	"title_text" text,
	"add_title" boolean DEFAULT true NOT NULL,
	"add_episode_number" boolean DEFAULT true NOT NULL,
	"add_glow_effect" boolean DEFAULT false NOT NULL,
	"ai_model" text DEFAULT 'gemini' NOT NULL,
	"credits_used" integer DEFAULT 0 NOT NULL,
...
--> statement-breakpoint
ALTER TABLE "clips" ALTER COLUMN "job_id" DROP NOT NULL;--> statement-breakpoint
...
ALTER TABLE "caption_jobs" ADD CONSTRAINT "caption_jobs_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "caption_jobs" ADD CONSTRAINT "caption_jobs_upload_id_uploads_id_fk" FOREIGN KEY ("upload_id") REFERENCES "public"."uploads"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "caption_jobs" ADD CONSTRAINT "caption_jobs_project_id_projects_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."projects"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "thumbnail_jobs" ADD CONSTRAINT "thumbnail_jobs_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "thumbnail_jobs" ADD CONSTRAINT "thumbnail_jobs_upload_id_uploads_id_fk" FOREIGN KEY ("upload_id") REFERENCES "public"."uploads"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "thumbnail_jobs" ADD CONSTRAINT "thumbnail_jobs_project_id_projects_id_fk" FOREIGN KEY ("project_id") REFERENCES "public"."projects"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "caption_jobs_workspace_idx" ON "caption_jobs" USING btree ("workspace_id");--> statement-breakpoint
...
CREATE INDEX "team_invitations_workspace_idx" ON "team_invitations" USING btree ("workspace_id");--> statement-breakpoint
CREATE INDEX "thumbnail_jobs_workspace_idx" ON "thumbnail_jobs" USING btree ("workspace_id");