...
function PricingContent() {
  ...
  const handleSubscribe = async (planId: PlanType, paymentType: "trial" | "instant" = "instant") => {
    const loadingKey = `${planId}-${paymentType}`;
    ...
    <div style={{ minHeight: "100vh", background: "var(--background)" }}>
      ...
      <div style={{
        ...
        <div className="pricing-card" style={{
          ...
          <button 
            onClick={() => handleSubscribe("starter", "trial")}
            disabled={loadingPlan === "starter-trial"}
            style={{
              width: "100%",
              padding: "14px 24px",
              ...
              fontSize: "16px",
              fontWeight: 600,
              cursor: loadingPlan === "starter-trial" ? "not-allowed" : "pointer",
              marginBottom: "12px",
              transition: "background 0.2s",
              opacity: loadingPlan === "starter-trial" ? 0.7 : 1,
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
              gap: "8px"
            }}>
            {loadingPlan === "starter-trial" ? <Loader2 size={20} className="animate-spin" /> : "Start your free trial"}
          </button>

          <button 
            onClick={() => handleSubscribe("starter", "instant")}
            disabled={loadingPlan === "starter-instant"}
            style={{
              width: "100%",
              padding: "14px 24px",
              ...
              fontSize: "16px",
              fontWeight: 600,
              cursor: loadingPlan === "starter-instant" ? "not-allowed" : "pointer",
              marginBottom: "12px",
              transition: "all 0.2s",
              opacity: loadingPlan === "starter-instant" ? 0.7 : 1,
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
              gap: "8px"
            }}>
            {loadingPlan === "starter-instant" ? <Loader2 size={20} className="animate-spin" /> : "Pay instantly"}
          </button>
        ...
        <div className="pricing-card popular" style={{
          ...
          <button 
            onClick={() => handleSubscribe("pro", "trial")}
            disabled={loadingPlan === "pro-trial"}
            style={{
              width: "100%",
              padding: "14px 24px",
              background: "var(--primary)",
              ...
              fontSize: "16px",
              fontWeight: 600,
              cursor: loadingPlan === "pro-trial" ? "not-allowed" : "pointer",
              marginBottom: "12px",
              transition: "background 0.2s",
              opacity: loadingPlan === "pro-trial" ? 0.7 : 1,
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
              gap: "8px"
            }}>
            {loadingPlan === "pro-trial" ? <Loader2 size={20} className="animate-spin" /> : "Start your free trial"}
          </button>

          <button 
            onClick={() => handleSubscribe("pro", "instant")}
            disabled={loadingPlan === "pro-instant"}
            style={{
              width: "100%",
              padding: "14px 24px",
              background: "transparent",
              ...
              fontSize: "16px",
              fontWeight: 600,
              cursor: loadingPlan === "pro-instant" ? "not-allowed" : "pointer",
              marginBottom: "12px",
              transition: "all 0.2s",
              opacity: loadingPlan === "pro-instant" ? 0.7 : 1,
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
              gap: "8px"
            }}>
            {loadingPlan === "pro-instant" ? <Loader2 size={20} className="animate-spin" /> : "Pay instantly"}
          </button>
