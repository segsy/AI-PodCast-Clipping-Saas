        ...
        <div style={{ flex: 1 }}>
          ...
          {activeTab === "profile" && (
            <div style={{ backgroundColor: "var(--surface)", borderRadius: "12px", border: "1px solid var(--border)", padding: "24px" }}>
              <h2 style={{ fontSize: "18px", fontWeight: "600", marginBottom: "24px", color: "white" }}>Profile Information</h2>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "16px" }}>
                  <div>
                    <label style={{ display: "block", fontSize: "14px", fontWeight: 500, marginBottom: "8px", color: "white" }}>First Name</label>
                  ...
                  <div>
                    <label style={{ display: "block", fontSize: "14px", fontWeight: 500, marginBottom: "8px", color: "white" }}>Last Name</label>
                  ...
                  <div style={{ gridColumn: "1 / -1" }}>
                    <label style={{ display: "block", fontSize: "14px", fontWeight: 500, marginBottom: "8px", color: "white" }}>Company</label>
          ...
          {activeTab === "security" && (
            <div style={{ backgroundColor: "var(--surface)", borderRadius: "12px", border: "1px solid var(--border)", padding: "24px" }}>
              <h2 style={{ fontSize: "18px", fontWeight: "600", marginBottom: "24px", color: "white" }}>Security Settings</h2>
              
              <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
                {/* Change Password */}
                <div>
                  <h3 style={{ fontWeight: 500, marginBottom: "16px", color: "white" }}>Change Password</h3>
                  <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                    <div>
                      <label style={{ display: "block", fontSize: "14px", fontWeight: 500, marginBottom: "8px", color: "white" }}>Current Password</label>
                    ...
                    <div>
                      <label style={{ display: "block", fontSize: "14px", fontWeight: 500, marginBottom: "8px", color: "white" }}>New Password</label>
                      <input type="password" style={{
                        width: "100%",
                        padding: "8px 16px",
                        backgroundColor: "var(--surface-hover)",
                    ...
                    <div>
                      <label style={{ display: "block", fontSize: "14px", fontWeight: 500, marginBottom: "8px", color: "white" }}>Confirm New Password</label>
                      <input type="password" style={{
                        width: "100%",
                        padding: "8px 16px",
                        backgroundColor: "var(--surface-hover)",
                ...
                <div style={{ paddingTop: "24px", borderTop: "1px solid var(--border)" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <div>
                      <h3 style={{ fontWeight: 500, color: "white" }}>Two-Factor Authentication</h3>
                ...
                {/* Active Sessions */}
                <div style={{ paddingTop: "24px", borderTop: "1px solid var(--border)" }}>
                  <h3 style={{ fontWeight: 500, marginBottom: "16px", color: "white" }}>Active Sessions</h3>
                  <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "12px", backgroundColor: "var(--surface-hover)", borderRadius: "8px" }}>
                      <div>
                        <p style={{ fontWeight: 500, color: "white" }}>Chrome on MacOS</p>
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "12px", backgroundColor: "var(--surface-hover)", borderRadius: "8px" }}>
                      <div>
                        <p style={{ fontWeight: 500, color: "white" }}>Safari on iPhone</p>
                        <p style={{ color: "var(--text-muted)", fontSize: "14px" }}>San Francisco, CA • 2 hours ago</p>
                      </div>
                      <button style={{ color: "var(--error)", fontSize: "14px", background: "none", border: "none", cursor: "pointer", textDecoration: "underline" }}>Revoke</button>
                    </div>
                  </div>
                </div>
              </div>
          ...
          {activeTab === "notifications" && (
            <div style={{ backgroundColor: "var(--surface)", borderRadius: "12px", border: "1px solid var(--border)", padding: "24px" }}>
              <h2 style={{ fontSize: "18px", fontWeight: "600", marginBottom: "24px", color: "white" }}>Notification Preferences</h2>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
                {[
                  ...
                  <div key={index} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", paddingBottom: "12px", borderBottom: index < 3 ? "1px solid var(--border)" : "none" }}>
                    <div>
                      <p style={{ fontWeight: 500, color: "white" }}>{item.title}</p>
          ...
          {activeTab === "api" && (
            <div style={{ backgroundColor: "var(--surface)", borderRadius: "12px", border: "1px solid var(--border)", padding: "24px" }}>
              <h2 style={{ fontSize: "18px", fontWeight: "600", marginBottom: "24px", color: "white" }}>API Keys</h2>
              
              <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
                <div>
                  <h3 style={{ fontWeight: 500, marginBottom: "8px", color: "white" }}>Your API Key</h3>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                    <div style={{ flex: 1, display: "flex", alignItems: "center", gap: "8px", padding: "12px", backgroundColor: "var(--surface-hover)", borderRadius: "8px" }}>
                      <code style={{ flex: 1, fontFamily: "monospace", fontSize: "14px", color: "white" }}>
                ...
                {/* API Usage */}
                <div style={{ paddingTop: "16px", borderTop: "1px solid var(--border)" }}>
                  <h3 style={{ fontWeight: 500, marginBottom: "16px", color: "white" }}>API Usage This Month</h3>
                  <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "16px" }}>
                    <div style={{ padding: "16px", backgroundColor: "var(--surface-hover)", borderRadius: "8px" }}>
                      ...
                      <p style={{ fontSize: "30px", fontWeight: "bold", marginTop: "4px", color: "white" }}>12,450</p>
                    </div>
                    <div style={{ padding: "16px", backgroundColor: "var(--surface-hover)", borderRadius: "8px" }}>
          ...
          {activeTab === "preferences" && (
            <div style={{ backgroundColor: "var(--surface)", borderRadius: "12px", border: "1px solid var(--border)", padding: "24px" }}>
              <h2 style={{ fontSize: "18px", fontWeight: "600", marginBottom: "24px", color: "white" }}>Preferences</h2>
              
              <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
                <div>
                  <label style={{ display: "block", fontSize: "14px", fontWeight: 500, marginBottom: "8px", color: "white" }}>Language</label>
                  <select style={{
                    width: "100%",
                    padding: "8px 16px",
                    backgroundColor: "var(--surface-hover)",
                ...
                <div>
                  <label style={{ display: "block", fontSize: "14px", fontWeight: 500, marginBottom: "8px", color: "white" }}>Timezone</label>
                  <select style={{
                    width: "100%",
                    padding: "8px 16px",
                    backgroundColor: "var(--surface-hover)",
                ...
                <div>
                  <label style={{ display: "block", fontSize: "14px", fontWeight: 500, marginBottom: "8px", color: "white" }}>Date Format</label>
                  <select style={{
                    width: "100%",
                    padding: "8px 16px",
                    backgroundColor: "var(--surface-hover)",
                ...
                <div>
                  <label style={{ display: "block", fontSize: "14px", fontWeight: 500, marginBottom: "8px", color: "white" }}>Default Dashboard View</label>
                  <select style={{
                    width: "100%",
                    padding: "8px 16px",
                    backgroundColor: "var(--surface-hover)",
